        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-4 mt-4">
              <div className="card shadow-sm">
                <img 
                  src="https://images.unsplash.com/photo-1464983953574-0892a716854b?crop=entropy&cs=tinysrgb&fit=max&w=400&h=225"
                  className="card-img-top"
                  alt="Book Album 4"
                />
                <div className="card-body">
                  <p className="card-text">
                    Buku sains populer yang membuka wawasan tentang alam semesta dan teknologi.
                  </p>
                  <br />
                  <div className="d-flex justify-content-between align-items-center">
                    <div className="btn-group">
            ...
            <div className="col-md-4 mt-4">
              <div className="card shadow-sm">
                <img 
                  src="https://images.unsplash.com/photo-1507842217343-583bb7270b66?crop=entropy&cs=tinysrgb&fit=crop&w=400&h=267"
                  className="card-img-top"
                  alt="Book Album 5"
                />
                <div className="card-body">
                  <p className="card-text">
                    Kumpulan puisi dan sastra yang menyentuh hati dan penuh makna kehidupan.
                  </p>
                  <br />
                  <div className="d-flex justify-content-between align-items-center">
                    <div className="btn-group">
                    ...
                    <small className="text-body-secondary">3 hours ago</small>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-md-4 mt-4">
              <div className="card shadow-sm">
                <img 
                  src="https://images.unsplash.com/photo-1519681393784-d120267933ba?crop=entropy&cs=tinysrgb&fit=max&w=400&h=225"
                  className="card-img-top"
                  alt="Book Album 6"
                />
                <div className="card-body">
                  <p className="card-text">
                    Buku anak-anak penuh ilustrasi warna-warni yang seru untuk dibaca bersama keluarga.
                  </p>
                  <br />
                  <div className="d-flex justify-content-between align-items-center">
                    <div className="btn-group">
                    ...
                    <small className="text-body-secondary">5 hours ago</small>
                  </div>
                </div>
              </div>
            </div>
